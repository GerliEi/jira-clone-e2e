class IssueDetailModal {
    constructor() {
        ...
        // type or assignees should have value (contain or have text)
    ...
    deleteIssue() {
        ...
        // Confirm if issue has to be deleted or cancel
    ...
    updateIssueDescriptionTo(description) {
        ...
        // see on korduv, et tuleb klikkida bottomRight
...
// let issue = new IssueDetailModal (); (it is the same than previous row)